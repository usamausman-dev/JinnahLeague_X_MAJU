    ...
    return (
        <div className='flex h-screen bg-red-500'>
            <div className='m-auto bg-slate-50 rounded-md w-3/5  grid lg:grid-cols-2'>
                ...
                <div className='sm:hidden rounded  lg:block bg-[url("https://i0.wp.com/alkhan.com.pk/wp-content/uploads/2022/06/best-continental-restaurant-in-lahore.jpg?fit=784%2C597&ssl=1")] '>
                </div>
                    ...
                    <div className='text-center py-10'>
                        <section className='w-3/4 mx-auto flex flex-col gap-5'>
                            ...
                            <form className='flex flex-col gap-3' onSubmit={formik.handleSubmit}>
                                ...
                                <div className={formik.errors.userName && formik.touched.userName ? "flex border rounded-xl relative border-red-700 " : "flex border rounded-xl relative"}>
                                    ...
                                    />
                                    <span className='icon flex items-center px-4 peer-focus:text-red-500'>  <HiUser size={25} /></span>
                                </div>
                                ...
                                <div>
                                    <button className='w-full bg-gradient-to-r from-red-500 to-red-600 rounded-md py-3 text-gray-50 text-lg hover:bg-gradient-to-r hover:from-gray-50 hover:to-gray-100 hover:text-red-500 hover:border-red-500  hover:border' type='submit'>Sign Up</button>
                                </div>
                            </form>
                            <p className='text-center text-gray-400'>
                                Already have an Account?
                                <Link className='ml-2 text-red-500' href="/login">Sign In</Link>
                            </p>
                        </section>
                    </div>
                </div>
